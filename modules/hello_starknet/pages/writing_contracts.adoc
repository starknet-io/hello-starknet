...
xref:calling_contracts.adoc#calling-contracts[Calling another contract]).
...
xref:deploying_from_contracts.adoc#deploying-from-contracts[deploy
system call].
...
xref:account_setup.adoc#account-setup[Setting up a
StarkNet account].
====
